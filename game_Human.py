...
RED = (255, 0 , 0)
BLACK = (0,0,0)
BACKGROUND = (255, 248,80)
BORDER_COLOUR = (255, 199, 0)
SPECIAL_FOOD = (125, 60, 152)
BLUE1  =(0,0,255) #dark
BLUE2 = (0,100,255) #light
...
class SnakeGame_Player:
    ...
    def place_big_food(self):
        x = random.randint(self.b//self.big_food_size , (self.w - self.b - self.big_food_size)//self.big_food_size)*self.big_food_size
        y = random.randint(self.b//self.big_food_size , (self.h - self.b - self.big_food_size)//self.big_food_size)*self.big_food_size
    ...
    def place_food(self):
        ...
        if self.small_food_count % 5 == 0:
            ...
            # print("This is from big food")
            # print("big food position : ",self.big_food)
            # print("big Small position :",self.small_food)
            # print(40*"-")
            self.place_big_food()
        else:
            # print("This is from small food")
            # print("big food position : ",self.big_food)
            # print("big Small position :",self.small_food)
            # print(40*"+")
            self.place_small_food()
    ...
    def update_ui(self):
        ...
        pygame.draw.rect(self.display, BACKGROUND, [self.b, self.b, self.w_nb, self.h_nb])
        
        for pt in self.snake:
            pygame.draw.rect(self.display, BLUE1, pygame.Rect(pt.x, pt.y, SNAKE_BLOCK, SNAKE_BLOCK))
        ...
        if self.show_big_food:
            ...
            remaining_time_text = self.font.render("special Food: " + str(int(remaining_time / 1000)) + "s", True, BLACK)
...
def game2():
    return SnakeGame_Player
if __name__ == '__main__':
    game = SnakeGame_Player()
